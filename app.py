...
def motor_precision_v36(texto):
    # Valores base (Alicia Albornoz) por si el archivo no se lee bien
    info = {
    ...
    if texto:
        ...
        # Datos Técnicos (FA en el PDF es la fracción de acortamiento/eyección técnica)
...
# --- 2. GENERADOR DE WORD (ESTILO PROFESIONAL PASTORE) ---
def crear_word_v36(texto_ia, datos_v, pdf_bytes):
    doc = Document()
